                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="proses.php">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="" value="<?php
                                                                                                                    if (!empty($_COOKIE['last_in'])) {
                                                                                                                        echo $_COOKIE['last_in'];
                                                                                                                    } ?>" placeholder="masukan username atau email!" name="user" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="" placeholder="Password" name="pass" required>
                                        </div>
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span class="input-group-text mr-2" id=""><?php echo $rand1 . " " . $randoperator . " " . $rand2; ?></span>
